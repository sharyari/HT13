...
\begin{enumerate}
	...
	\answer $U_1$ is now 0.4, giving $U = 0.9523$, which means that it is not guaranteed to be schedulable \todo{svarar på mer än frågan?} according to the formula.
...
\end{lstlisting}
	...
	$R_3$ and $R_4$ show that two tasks may miss their deadlines. These numbers are reasonable \todo{varför?}
